...
def inventory_overview(dc_code: str = "*") -> dict[str, Any]:
    ...
    panels = [
        ...
        },
        {
            ...
            "service_label": "IBM ICOS S3 — Ankara",
            "family": "storage_s3",
            ...
            "free_qty": 75.0,
            "sellable_qty": 51.0,
            "potential_tl": 102000.0,
            "unit_price_tl": 2000.0,
            "used_tl": 90000.0,
            "sellable_profile": "standard",
            "sellable_alloc_qty": None,
            "sellable_max_qty": None,
            "potential_tl_alloc": 102000.0,
            "potential_tl_max": None,
            "has_infra_source": True,
            "has_price": True,
            "infra_binding": "bound",
            "status": "over",
            "delta_used_vs_crm": 37.0,
            "overage_qty": 37.0,
            "efficiency_pct": 562.5,
            "crm_products_summary": "S3 Ankara SKU",
            "computation_mode": "aggregated",
            "data_quality": None,
        },
        {
            "panel_key": "storage_s3_istanbul",
            "label": "IBM ICOS S3 — İstanbul",
            "service_label": "IBM ICOS S3 — İstanbul",
            "family": "storage_s3",
            "family_label": "IBM ICOS S3",
            "resource_kind": "storage",
            "display_unit": "TB",
            ...
            "infra_binding": "bound",
            "status": "over",
            "delta_used_vs_crm": 48.0,
            "overage_qty": 48.0,
            "efficiency_pct": 500.0,
            "crm_products_summary": "S3 Istanbul SKU",
            "computation_mode": "aggregated",
            "data_quality": None,
        },
        {
